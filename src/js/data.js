    ...
    top_spots: [
      {
        ...
        blurb:
          "This is an outstanding opera house that offers beautiful architecture and performances. You can purchase tickets to attend performances and take guided tours to learn more about its history.",
        isSelected: false,
      },
      {
        name: "San Telmo",
        ...
        blurb:
          "This is the oldest neighborhood in Buenos Aires that offers many different tastes of the city. You can find coffee shops, shops, restaurants, and many more! There's also a weekly street fair on Sundays where you can buy souvenirs to take home.",
        isSelected: false,
      },
    ],
    places_to_eat: [
      {
        ...
        blurb:
          "This is a 5-star Michelin restaurant that offers Asado steak tradition with a twist. Not only will you have amazing steak and barbeque, you'll also have an unforgetable experience!",
        isSelected: false,
      },
      {
        ...
        blurb:
          "This beautiful restaurant offers Italian, Mediterranean, and European cuisine. It is also vegetarian and gluten free friendly with vegan options.",
        isSelected: false,
      },
    ],
    lodging: [
      {
        ...
        blurb:
          "This hotel is an 8-block walk from Florida Street and has been rated 8-9/10 from guests. Some of the amenities offered include: indoor swimming pool, airport shuttle, breakfast, free wifi, air conditioning, hot tub, and many more!",
        isSelected: false,
      },
      {
        name: "Hub Porteño",
        ...
        blurb:
          "This is a 1957 French-style home that was previously used as a guest house by an Argentinian family. It continues to provide a home like feel. Some of the amenities offered include: suites with various views (city, garden, and winter garden), a dry sauna, a mini gym, and many more!",
        isSelected: false,
      },
    ],
  },
    ...
    top_spots: [
      {
        ...
        blurb:
          "This full day tour allows you to see and explore the Andes Mountains. Depending on the time of year you visit, the view could be covered in snow or completely dry!",
        isSelected: false,
      },
      {
        ...
        blurb:
          "This winery offers beautiful views and delicious wines. This experience allows you to experience the offerings privately with your group and indulge in the experience!",
        isSelected: false,
      },
    ],
    places_to_eat: [
      {
        ...
        blurb:
          "This is a 5-star Michelin restaurant that offers healthy Argentina cuisine. It has a connected winery and its very own organic garden that their vegetables are sourced from.",
        isSelected: false,
      },
      {
        ...
        blurb:
          "This 4.5 star winery offers a wide variety of wine and cuisine options. You'll get to have the full wine tasting experience with wine and their pairings.",
        isSelected: false,
      },
    ],
    lodging: [
      {
        ...
        blurb:
          "This hotel is located in La Carrera, offering a mixture of mountains and countryside. Some of the amenitites offered include: an outdoor swimming pool, airport shuttle, a bar, and many more!",
        isSelected: false,
      },
      {
        ...
        blurb:
          "This hotel is located right in the city's center and is just 10 minute drive from the airport. Some of the amenities offered include: a suana room, an outdoor pool, a Mediterranean restaurant, and many more!",
        isSelected: false,
      },
    ],
  },
