    ...
    city.top_spots.forEach((spots, index) => {
        topSpotsList.innerHTML += `
            <div class="accordion-item">
                ...
                <div id="TopSpots-collapse${index}" class="accordi-collapse collapse"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    addRemoveCityButtons.forEach(function (button) {
        ...
        button.addEventListener('click', function () {
            ...
            if (isAdding) {
                addCityToBLFromOffcanvas(buttonId, usCities);
            } else {
                removeCityFromBLFromOffcanvas(buttonId, usCities);
            }
